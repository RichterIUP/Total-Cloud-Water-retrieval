...
MICROWINDOWS[11] = [855.5, 858.0]
MICROWINDOWS[12] = [860.1, 864.0]
MICROWINDOWS[13] = [866.0, 870.0]
MICROWINDOWS[14] = [872.2, 877.5]
MICROWINDOWS[15] = [884.5, 886.0]
MICROWINDOWS[16] = [891.9, 897.0]
MICROWINDOWS[17] = [898.2, 905.4]
MICROWINDOWS[18] = [911.0, 913.0]
MICROWINDOWS[19] = [914.5, 917.0]
MICROWINDOWS[20] = [929.6, 930.5]
MICROWINDOWS[21] = [931.5, 932.0]
MICROWINDOWS[22] = [1092.1, 1098.8]
...
def average(wavenumber, radiance):
    ...
    new_radiance = [1e2*(new_radiance[0] - new_radiance[11])/(wavenumber[0] - wavenumber[11]), 1e4*(new_radiance[12] - new_radiance[-1])/(wavenumber[12] - wavenumber[-1]), np.sum(new_radiance[0:12]), np.sum(new_radiance[12:-1])]
